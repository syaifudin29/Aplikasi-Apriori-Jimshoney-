...
<head>
    ...
    <link href="<?php echo base_url('/dist/'); ?>/vendor/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">JIMSHONEY</div>
            </a>
          ...
          <li class="nav-item <?php echo $menu == 'barang' ? 'active' : ''; ?>">
                <a class="nav-link" href="/barang">
                    <i class="fas fa-fw fa-folder"></i>
                    <span>Data Barang</span></a>
            </li>
            <li class="nav-item <?php echo $menu == 'penjualan' ? 'active' : ''; ?>">
                <a class="nav-link" href="/transaksi">
                    <i class="fas fa-fw fa-dolly"></i>
                    <span>Data Transaksi</span></a>
            </li>
            <!-- Nav Item - proses apriori -->
             <li class="nav-item <?php echo $menu == 'apriori' ? 'active' : ''; ?>">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="<?php echo base_url('/dist/'); ?>/img/undraw_profile.svg">
                            </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Apriori JimsHoney</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <script src="<?php echo base_url('/dist'); ?>/js/sb-admin-2.min.js"></script>
        ...
        <!-- Page level plugins -->
    <script src="<?php echo base_url('/dist'); ?>/vendor/datatables/jquery.dataTables.min.js"></script>
